...
<body class="produto">
  ...
  <header id="layout-header">
	...
	<nav class="categories-nav">
		<ul class="container">
			<li class="category"><a href="localhost:8080/casadocodigo/">Home</a></li>
	  ...
	  <form action='<c:url value="/carrinho/add" />' method="POST" class="container">
	    <ul id="variants" class="clearfix">
	    	...
	    	<c:forEach items="${produto.precos}" var="preco">
	    	  <li class="buy-option">
	            <input type="radio" name="tipoPreco" id="tipoPreco" value="${preco.tipoPreco}" class="variant-radio" checked="checked"/>
	...
	<div class="container">
	  ...
	  <section class="data product-detail">
	    ...
	    <%-- Verificar como faz para formatar uma data que seja LocalDate
